...

{
	...
	JPanel pnBorder=new JPanel(); pnBorder.setLayout(new BorderLayout()); JPanel pnNorth=new JPanel();
	...
	Font ft=new Font("arial", Font.BOLD, 25); lblTitle.setFont(ft);

	JPanel pnWest=new JPanel();

	pnWest.setLayout(new BoxLayout(pnWest, BoxLayout.Y_AXIS)); JButton btnGiai=new JButton("Giải "); JButton btnXoa=new JButton("Xóa ");
	...
	TitledBorder southTitleBorder= new TitledBorder(southborder, "Chọn tác vụ"); pnWest.setBorder(southTitleBorder);
	JPanel pnSouth=new JPanel(); pnSouth.setPreferredSize(new Dimension(0, 30)); pnSouth.setBackground(Color.PINK); JPanel pns1=new JPanel();
	...
	{ 
		...
		{
			bai5 ui=new bai5("Cộng - Trừ - Nhân -Chia");
			ui.doShow();
	}
